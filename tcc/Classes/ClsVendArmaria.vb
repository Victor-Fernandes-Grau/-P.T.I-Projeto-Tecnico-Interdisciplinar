Public Class ClsVendArmaria
    ...
    Public Sub gravar()
        ...
        sql = "Insert into TabLoc (totpreco, Codfunc, comanda, data) values ('" & m_preco & "','" & m_codfunc & "', '" & m_codcoman & "', '" & m_data & "'  )"
