...
Public Class CrpVendaArmariaFunc
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CrpVendaArmariaFunc.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "tcc.CrpVendaArmariaFunc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpVendaArmariaFunc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpVendaArmariaFunc = New CrpVendaArmariaFunc()
        rpt.Site = Me.Site
        Return rpt
    End Function
