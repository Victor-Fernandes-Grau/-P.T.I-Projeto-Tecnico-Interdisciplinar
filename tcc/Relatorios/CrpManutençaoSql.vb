...
Public Class CrpManutençaoSql
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "tcc.CrpManutençaoSql.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpManutençaoSql
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpManutençaoSql = New CrpManutençaoSql()
        rpt.Site = Me.Site
        Return rpt
    End Function
