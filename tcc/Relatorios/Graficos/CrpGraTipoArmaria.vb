...
Public Class CrpGraTipoArmaria
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "tcc.CrpGraTipoArmaria.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpGraTipoArmaria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpGraTipoArmaria = New CrpGraTipoArmaria()
        rpt.Site = Me.Site
        Return rpt
    End Function
