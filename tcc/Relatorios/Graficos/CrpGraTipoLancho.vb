...
Public Class CrpGraTipoLancho
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "tcc.CrpGraTipoLancho.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpGraTipoLancho
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpGraTipoLancho = New CrpGraTipoLancho()
        rpt.Site = Me.Site
        Return rpt
    End Function
