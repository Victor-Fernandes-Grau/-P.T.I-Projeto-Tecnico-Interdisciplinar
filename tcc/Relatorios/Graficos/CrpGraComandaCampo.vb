...
Public Class CrpGraComandaCampo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "tcc.CrpGraComandaCampo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpGraComandaCampo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpGraComandaCampo = New CrpGraComandaCampo()
        rpt.Site = Me.Site
        Return rpt
    End Function
