Public Class FrmArmaria
    ...
    Private Sub TxtPro_LostFocus(sender As Object, e As EventArgs) Handles TxtPro.LostFocus
        If TxtPro.Text <> "" Then
            If objproArma.localizar(TxtPro.Text) Then
                ...
                TxtPre.Text = Format(objproArma.preco, "0.00")
    ...
    Private Sub baixar_estoque()
        objproArma.baixar_estoque(TxtPro.Text, TxtQtd.Text)
    End Sub
    ...
    Private Sub BtnGra_Click(sender As Object, e As EventArgs) Handles BtnGra.Click
        ...
        Else
            ...
            objven.totpreco = TxtGer.Text
            objven.gravar()
            TxtCod.Text = objven.Codloc
            For x = 0 To DgdGrade.Rows.Count - 1
                objitem.codigo = TxtCod.Text
                objitem.sequencia = x
                objitem.Codproarma = DgdGrade.Rows(x).Cells(0).Value
    ...
    Private Sub DgdGrade_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DgdGrade.CellDoubleClick
        If DgdGrade.Rows.Count > 0 Then
            Dim id As Integer
            Dim qtd As Integer
            'passa os dados da grade para variáveis
            id = DgdGrade.CurrentRow.Cells(0).Value
            qtd = DgdGrade.CurrentRow.Cells(3).Value
            'faz updade da tabela de produtos devolvendo a qtd
            objproArma.devolver_estoque(id, qtd)
    ...
    Private Sub BtnLocCli_LostFocus(sender As Object, e As EventArgs) Handles BtnLocCli.LostFocus
